namespace FPServer
{
    ...
    internal class Request : SimpleWorkerRequest
    {
        ...
        private static string[] s_defaultFilenames = new string[] { "default.html", "index.html", "default.aspx", "index.aspx", "default.htm", "index.htm" };
        ...
        public override string GetServerVariable(string name)
        {
            ...
            return ("WMSServer/" + Messages.VersionString);
        }
        ...
        private void ParseHeaders()
        {
            ...
            {
                string str = ((ByteString) this._headerByteStrings[num]).GetString();
